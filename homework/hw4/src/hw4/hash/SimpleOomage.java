...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        SimpleOomage currentObject = (SimpleOomage) o;
        return (currentObject.red == this.red) && (currentObject.green == this.green) && (currentObject.blue == this.blue);
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            int result = ((Integer)(red / 5)) != null ? ((Integer)(red / 5)).hashCode() : 0;
            result = result * 31 + (((Integer)(green / 5)) != null ? ((Integer)(green / 5)).hashCode() : 0);
            result = result * 31 + (((Integer)(blue / 5)) != null ? ((Integer)(blue / 5)).hashCode() : 0);
            return result;
        }
    }
